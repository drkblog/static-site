...
<a href="http://blog.drk.com.ar/wp-content/uploads/2016/01/lcd-ir-demo_bb.png" rel="attachment wp-att-2407"><img loading="lazy" class="aligncenter size-large wp-image-2407" src="http://blog.drk.com.ar/wp-content/uploads/2016/01/lcd-ir-demo_bb-1024x831.png" alt="Circuito control remoto arduino y LCD" width="474" height="385" srcset="https://blog.drk.com.ar/wp-content/uploads/2016/01/lcd-ir-demo_bb.png 1024w, https://blog.drk.com.ar/wp-content/uploads/2016/01/lcd-ir-demo_bb-300x243.png 300w, https://blog.drk.com.ar/wp-content/uploads/2016/01/lcd-ir-demo_bb-768x623.png 768w" sizes="(max-width: 474px) 100vw, 474px" /></a>

<!--more-->Los terminales extremos del potenciómetro se conectan entre Vcc y GND creando un divisor resistivo. El cursor del potenciómetro se conecta al pin 3 (VO) del LCD. Los pines 1 y 2 del LCD a GND y a Vcc respectivamente. Los pines 4 (RS) y 6 (E) del LCD a los pines 12 y 11 del Arduino. El pin 5 (RW) a GND. Los pines 7 (D0) al 10 (D3) sin conexión. Del 11 (D4) al 14 (D7) a los pines del 5 al 2 (El 11 al 5, el 12 al 4 y así). El pin 15 (A) a la resistencia de 220Ω y ésta a Vcc, el pin 16 (K) a GND. 
...
ID
:   (long) Contiene el código de la tecla del control remoto

value
:   (int) El valor asociado a esa tecla

cmd
:   (command) Un puntero a la función que debe ejecutarse
