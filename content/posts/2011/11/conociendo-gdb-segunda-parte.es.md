...
Continuar con la exploración de las diferentes posibilidades de GDB, tal como se adelantó en el [artículo inicial][1].
...
```
(gdb) br rand.c:16
Breakpoint 1 at 0x80484ec: file rand.c, line 16.
```
...
```
(gdb) br 20
Breakpoint 1 at 0x804857d: file array.c, line 20.
```
...
0xbffff7c8:     97 'a'  0 '\000'        0 '\000'        0 '\000'
```
...
0x804a018:      80 'P'  114 'r' 105 'i' 109 'm'
```
...
```
(gdb) x/2xw variable
0x804a008:      0x0804a018      0x0804a028
```
...
```
(gdb) x/8c 0x0804a028
0x804a028:      83 'S'  101 'e' 103 'g' 117 'u' 110 'n' 100 'd' 97 'a'  0 '\000'
```
...
Hasta aquí hemos cubierto la gran mayoría de los comandos más utilizados en GDB para depurar aplicaciones de un sólo hilo de ejecución (_monothread_). En la tercera parte veremos cómo inspeccionar la cantidad de hilos existente y cómo pasar de un hilo a otro para inspeccionar sus respectivos _stacks_.
 ...
 [1]: /conociendo-gdb "Conociendo GDB primera parte"
